/* 荣誉证书 */
$(function(){
	var url = "http://wechat.ykit.net/jihuiapi/album/index/71248/1/20"; 
	$.ajax({
        type: "get",
        url: url,
        dataType: "jsonp",
        ...
        success : function(data){
            ...
            for (var i=0;i<length;i++) {
                ...
                html += '<div class="swiper-slide"><a href="javascript:;" data-url="'+ data.list[i].pic_path +'" onclick="show_cert(this)"><img src="'+ cert_url +'"></a></div>'; 
            }
